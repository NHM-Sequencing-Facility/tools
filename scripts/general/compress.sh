...
# Set input directory (NO TRAILING SLASH)
INPUT_DIR="/path/to/data/folder"

# Output filename (written to the parent directory of INPUT_DIR)
OUTPUT_FILE="$(dirname "$INPUT_DIR")/${INPUT_DIR##*/}.tar.gz"
