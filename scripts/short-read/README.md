...
Scripts for processing short-read sequencing data, typically produced by Illumina or Element Biosciences sequencers. Each script includes usage instructions in the header comments.
